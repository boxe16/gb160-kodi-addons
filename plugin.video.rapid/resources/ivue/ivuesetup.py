...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.rapid/resources/ivue','rapid.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.rapid/resources/ivue','plugin.video.rapid.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.rapid'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("rapid","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.rapid/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.rapid/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("rapid","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("rapid","Installing iVue TV Guide...",'', 'Please Wait')
