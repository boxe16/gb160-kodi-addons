...
def Get():
	...
	m3u  = 'http://clientsportals.net:8080%3A8080%2Fget.php%3Fusername%3D'+username+'%26password%3D'+password+'%26type%3Dm3u_plus%26output%3Dts'
	epg  = 'http://clientsportals.net:8080%3A8080%2Fxmltv.php%3Fusername%3D'+username+'%26password%3D'+password
	auth = 'http://clientsportals.net:8080/enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
	...
	if not auth=="":
		...
		xbmcgui.Dialog().ok('Rapid IPTV','[COLOR blue]M3U URL: [/COLOR]%s'%shortm3u,'','[COLOR blue]EPG URL: [/COLOR]%s'%shortepg)
	else:
		return