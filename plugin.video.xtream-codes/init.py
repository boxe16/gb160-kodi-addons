...
def stream_video(params):
    ...
    elif skin_used == 'skin.estuary_mod18':
...
def execute_ainfo(params):
    ...
    active = kasutajaAndmed[get_live("YWN0aXZlX2NvbnM=")]
    ...
    plugintools.add_item( action="",   title=vod_channels("W0NPTE9SID0gd2hpdGVdQWN0aXZlIGNvbm5lY3Rpb25zOiBbL0NPTE9SXQ==")+active , thumbnail="" , fanart=os.path.join(LOAD_LIVE,sync_data("YmFja2dyb3VuZC5wbmc=")) , folder=False )
    ##plugintools.set_view( plugintools.LIST )
def vanema_lukk(name):
        plugintools.log(pnimi+sync_data("UGFyZW51YWwgbG9jayA="))
        ...
        if any(s in name for s in a):
           ...
           text = plugintools.keyboard_input(default_text="", title=get_live("UGFyZW51YWwgbG9jaw=="))
